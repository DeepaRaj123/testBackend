    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/provider') }}"><img style="margin-top: -20px;"  src="{{ Setting::get('site_logo', asset('logo-black.png')) }}"></a>
            </div>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            
                <ul class="nav navbar-nav navbar-right">
                    <!-- <li><a href="{{ url('help') }}">@lang('provider.profile.help')</a></li> -->
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu">
                            <li class="row no-margin">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <a href="{{ route('provider.profile.index') }}" class="new-pro-link">@lang('provider.profile.my_profile')</a>
                                </div>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ route('provider.change.password')}}">@lang('provider.profile.change_password')</a></li>
                            <li>
