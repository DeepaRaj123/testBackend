            ...
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
                   ...
                   {{-- -  <!-- @if(Setting::get('razorpay') == 1)
                         <option value="razorpay">Razorpay <code>( Service currently unavailable )</code></option>

                      @endif -->  --}}
                     
                      @if(Setting::get('Korttimaksu') == 1)
                        <option value="Korttimaksu">Korttimaksu</option>
                      @endif
                      @if(Setting::get('Lasku') == 1)
                        <option value="Lasku">Lasku</option>
                      @endif
                      @if(Setting::get('MobilePay') == 1)
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        @php $duration='+15 days'; $durationtime='+1 hour'; @endphp
