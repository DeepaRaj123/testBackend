...
<div class="full-page-bg" style="background-image: url({{ asset('asset/img/login-bg-2.png') }});">
        ...
        <div class="row no-margin">
            ...
            <div class="col-md-12 log-right">
                ...
                <div class="login-box row no-margin">
                    ...
                    <div class="col-md-12">
                        <p class="helper pull-left"> <a href="{{ url('/password/reset') }}">Forgot Password</a></p>  
                        <p class="helper pull-right"> <a href="{{ url('register') }}">Create New Account</a></p>
