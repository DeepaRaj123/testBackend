        ...
        <div class="row no-margin">
            <div class="col-md-6">
                <form action="{{url('confirm/ride')}}" method="GET" onkeypress="return disableEnterKey(event);">
                    ...
                    <button type="submit"  class="full-primary-btn fare-btn">proceed</button>
...
<script type="text/javascript">
    var current_latitude = {{\Setting::get('current_latitude')}};
    var current_longitude = {{\Setting::get('current_longitude')}};
</script>
