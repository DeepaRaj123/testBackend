    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('contact_number', '911')  }}" name="contact_number" required id="contact_number" placeholder="Contact Number">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="contact_email" class="col-xs-2 col-form-label">@lang('admin.setting.current_latitude')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('current_latitude', '')  }}" name="current_latitude"  id="current_latitude" placeholder="eg: 26.709723">
					</div>
				</div>

				<div class="form-group row">
					<label for="contact_email" class="col-xs-2 col-form-label">@lang('admin.setting.current_longitude')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('current_longitude', '')  }}" name="current_longitude"  id="current_longitude" placeholder="eg: -80.064163" />
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="address" class="col-xs-2 col-form-label">@lang('admin.setting.address')</label>
					<div class="col-xs-10">
