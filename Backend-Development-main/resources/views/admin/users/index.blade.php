        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <table class="table table-striped table-bordered dataTable" id="table-5">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $page }}</td>
                        <td style="width:10% ;line-break: anywhere;">{{ $user->first_name }}</td>
                        <td style="width:10% ;line-break: anywhere;">{{ $user->last_name }}</td>
                        @if(Setting::get('demo_mode', 0) == 1)
                        <td style="width:20% ;line-break: anywhere;">{{ substr($user->email, 0, 3).'****'.substr($user->email, strpos($user->email, "@")) }}</td>
                        @else
                        <td style="width:20% ;line-break: anywhere;">{{ $user->email }}</td>
                        @endif
                        @if(Setting::get('demo_mode', 0) == 1)
                        <td>+919876543210</td>
                        @else
