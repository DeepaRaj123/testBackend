                        ...
                        <div class="tab-pane fade @if (!$errors->has('login_type')) active @endif in" id="signup">
                            ...
                            <form id="signup" role="form" method="POST" action="{{ url('/admin/login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off" @if(Setting::get('demo_mode',0) ==1)value="admin@uberlikeapp.com"@endif>
                                    @if ($errors->has('email'))
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    @if(Setting::get('demo_mode' , 0)==1)
                                        ...
                                        <h5><strong>User Name : </strong><span>admin@uberlikeapp.com</span></h5>
                            ...
                            <form id="login" role="form" method="POST" action="{{ url('/dispatcher/login') }}">
                             {{ csrf_field() }}
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off" @if(Setting::get('demo_mode',0) ==1)value="dispatcher@uberlikeapp.com"@endif>
                                    @if ($errors->has('email'))
                                        <p class="help-block text-danger">{{ $errors->first('email') }}</p>
                                    @endif
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="details">
                                        @if(Setting::get('demo_mode', 0)==1)
                                        <h4 class="text-captilize text-left">Using below detail for demo version</h4>
                                        <h5><strong>User Name : </strong><span>dispatcher@uberlikeapp.com</span></h5>
                                        <h5><strong>Password  : </strong><span>123456</span></h5>
                                        <p>Super Administrator can manage whole system and other user's rights too.</p>
                                        @endif
                                    </div>
                        ...
                        <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'fleet')  active @endif in" id="fleet">
                             ...
                             {{ csrf_field() }}
                                <div class="form-group">
                                    <label @if(Setting::get('demo_mode',0) ==1)class="active"@endif>Fleet Administrator E-mail<span class="req">*</span> </label>
                                        <input type="email" name="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off" @if(Setting::get('demo_mode',0) ==1)value="fleet@uberlikeapp.com"@endif>
                                        @if ($errors->has('email'))
                                            <p class="help-block text-danger">{{ $errors->first('email') }}</p>
                                        @endif
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    @if(Setting::get('demo_mode',0) ==1)
                                        <h4 class="text-captilize text-left">Using below detail for demo version</h4>
                                        <h5><strong>User Name : </strong><span>fleet@uberlikeapp.com</span></h5>
                                        <h5><strong>Password  : </strong><span>123456</span></h5>
                                        <p>Super Administrator can manage whole system and other user's rights too.</p>
                                        @endif
                                    </div>
                        ...
                        <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'account')  active @endif in" id="account">
                             ...
                             {{ csrf_field() }}
                                <div class="form-group">
                                    <label @if(Setting::get('demo_mode',0) ==1)class="active"@endif>Account Administrator E-mail<span class="req">*</span> </label>
                                        <input type="email" name="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off" @if(Setting::get('demo_mode',0) ==1)value="account@uberlikeapp.com"@endif>
                                        @if ($errors->has('email'))
                                            <p class="help-block text-danger">{{ $errors->first('email') }}</p>
                                        @endif
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    @if(Setting::get('demo_mode',0) ==1)
                                     <h4 class="text-captilize text-left">Using below detail for demo version</h4>
                                        <h5><strong>User Name : </strong><span>account@uberlikeapp.com</span></h5>
                                        <h5><strong>Password  : </strong><span>123456</span></h5>
                                        <p>Super Administrator can manage whole system and other user's rights too.</p>
                                    @endif
                                       </div>
