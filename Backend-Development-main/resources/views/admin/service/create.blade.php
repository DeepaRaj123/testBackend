        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row" id="hour_price">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('fixed') }}" name="hour"  id="hourly_price" placeholder="Set Hour Price( Only For DISTANCEHOUR )" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder="Base Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('distance') }}" name="distance" required id="distance" placeholder="Base Distance" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('minute') }}" name="minute" required id="minute" placeholder="Unit Time Pricing" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('price') }}" name="price" required id="price" placeholder="Unit Distance Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('capacity') }}" name="capacity" required id="capacity" placeholder="Capacity" min="1">
                    </div>
                </div>
