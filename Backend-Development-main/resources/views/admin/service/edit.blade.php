                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <textarea class="form-control" type="text" value="{{ $service->description }}"   name="description" required id="description" placeholder="Description" rows="4">{{ $service->description }}</textarea>
                    </div>
                </div>
