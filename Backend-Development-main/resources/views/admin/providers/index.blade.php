            ...
            <table class="table table-striped table-bordered dataTable" id="table-5">
                ...
                @php($page++)
                    <tr>
                        ...
                        @if(Setting::get('demo_mode', 0) == 1)
                        <td style="width:20% ;line-break: anywhere;">{{ substr($provider->email, 0, 3).'****'.substr($provider->email, strpos($provider->email, "@")) }}</td>
                        @else
                        <td style="width:20% ;line-break: anywhere;">{{ $provider->email }}</td>
                        @endif
                        @if(Setting::get('demo_mode', 0) == 1)
                        <td>+919876543210</td>
                        @else
