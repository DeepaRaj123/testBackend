...
<div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <p style="color:red;">{{Setting::get('booking_prefix', '') }} - Ride Transactions, PSET - Provider Settlements, FSET - Fleet Settlements, URC - User Recharges ,PRC - Provider Recharges </p>
            </div>
