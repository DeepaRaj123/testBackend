...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="height:50px;color:red;">
                ...
                @endif
            <h5 class="mb-1">Billing History</h5>
            @if(count($requests) != 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn btn-danger btn-block">
                               @if($request->lasku_billing_check == 0)
                                <a class="btn btn-danger btn-block" href="{{ url('admin/request_data/checked', $request->id ) }}">CHECKED</a>
                                @else
                                <a class="btn btn-success btn-block" href="{{ url('admin/request_data/unchecked', $request->id ) }}">UNCHECKED</a>
                                @endif
