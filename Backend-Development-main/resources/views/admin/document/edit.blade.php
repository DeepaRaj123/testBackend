    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.document.update', $document->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
                    ...
                    <div class="form-group row">
					 <label for="name" class="col-xs-2 col-form-label">Expiry Date</label>
                     <div class="col-xs-10">
                        <select name="doc_required">
                            <option value="YES" @if($document->doc_required == 'YES') selected @endif>YES</option>
                            <option value="NO" @if($document->doc_required == 'NO') selected @endif>NO</option>
                        </select>
                    </div>
                </div>
