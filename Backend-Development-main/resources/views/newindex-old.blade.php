...
<div class="row gray-section pad-60">
    <div class="container">                
        <div class="col-md-6">
            ...
            <div class="title-divider"></div>
            <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on Laba cabs taxi for a ride—no reservations needed.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center"> 
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>You can always request everyday cars at everyday prices. But sometimes you need a bit more space. Or you want to go big on style. With Laba cabs taxi, the choice is yours.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>A city with Laba cabs taxi has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it.</p>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>Whether riding in the backseat or driving up front, every part of the Laba cabs taxi experience has been designed around your safety and security.</p>
