...
Route::get('payment_mode',  'ProviderAuth\TokenController@payment_mode');
...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::group(['prefix' => 'profile'], function () {
        ...
        Route::get ('/documents/status', 'ProviderResources\ProfileController@documents_status');
        Route::post('/documents/store', 'ProviderResources\ProfileController@documentstore');   
        Route::post('/documents/update', 'ProviderResources\ProfileController@documentupdate');        
    ...
    Route::group(['prefix' => 'requests'], function () {
        ...
        Route::get('/wallet/passbook' , 'ProviderResources\TripController@wallet_passbook');
        Route::get('/status/check' , 'ProviderResources\TripController@active_check');

    });
    Route::post('/test/push' ,  'ProviderResources\TripController@test');

    Route::post('/rzp/success', 'PaymentController@provider_rzp_success');
