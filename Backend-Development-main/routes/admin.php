...
Route::get('request_data/checked/{id}', 'Resource\TripResource@checked')->name('checked');
Route::get('request_data/unchecked/{id}', 'Resource\TripResource@unchecked')->name('unchecked');
