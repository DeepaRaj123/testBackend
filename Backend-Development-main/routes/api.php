...
Route::get('payment_mode','UserApiController@payment_mode');
...
Route::post('dial', 'TwilioController@dial_number');
Route::get('/call/token', 'TwilioController@voiceaccesstoken');
